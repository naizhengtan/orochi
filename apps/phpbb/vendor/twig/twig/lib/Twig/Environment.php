...
class Twig_Environment
{
    ...
    {
        $name = sprintf('__string_template__%s', hash('sha256', cheng_uniqid(cheng_mt_rand(), true), false));
    ...
    public function isTemplateFresh($name, $time)
    {
        if (0 === $this->lastModifiedExtension) {
            foreach ($this->extensions as $extension) {
                ...
                if (file_exists($r->getFileName()) && ($extensionTime = cheng_filemtime($r->getFileName())) > $this->lastModifiedExtension) {
