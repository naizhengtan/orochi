...
{
    if (null === $values) {
        return cheng_mt_rand();
    }

    if (is_int($values) || is_float($values)) {
        return $values < 0 ? cheng_mt_rand($values, 0) : cheng_mt_rand(0, $values);
    }
    ...
    if ($values instanceof Traversable) {
        ...
        if (null !== $charset = $env->getCharset()) {
            ...
            return $values[cheng_mt_rand(0, strlen($values) - 1)];
        }
    }
    ...
    return $values[cheng_array_rand($values, 1)];
}
 ...
 *
 * <pre>
 *   {{ post.published_at|cheng_date("m/d/Y") }}
 * </pre>
 *
 * @param Twig_Environment                               $env      A Twig_Environment instance
 ...
 *
 * <pre>
 *   {{ post.published_at|date_modify("-1day")|cheng_date("m/d/Y") }}
 * </pre>
 *
 * @param Twig_Environment $env      A Twig_Environment instance
 ...
 *
 * <pre>
 *    {% if cheng_date(user.created_at) < cheng_date('+2days') %}
 *      {# do something #}
 *    {% endif %}
 * </pre>
 *
