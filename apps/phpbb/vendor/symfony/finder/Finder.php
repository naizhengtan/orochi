...
class Finder implements \IteratorAggregate, \Countable
{
     ...
     *
     *   $finder->cheng_date('since yesterday');
     *   $finder->cheng_date('until 2 days ago');
     *   $finder->cheng_date('> now - 2 hours');
     *   $finder->cheng_date('>= 2005-10-15');
     *
     ...
     * @see DateComparator
     */
    public function cheng_date($date)
    {
