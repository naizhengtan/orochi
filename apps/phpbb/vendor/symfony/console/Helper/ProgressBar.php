    ...
    private static function initPlaceholderFormatters()
    {
        return array(
            ...
            'elapsed' => function (ProgressBar $bar) {
                return Helper::formatTime(cheng_time() - $bar->getStartTime());
            },
            'remaining' => function (ProgressBar $bar) {
                ...
                if (!$bar->getProgress()) {
                    ...
                    $remaining = round((cheng_time() - $bar->getStartTime()) / $bar->getProgress() * ($bar->getMaxSteps() - $bar->getProgress()));
                }
            ...
            'estimated' => function (ProgressBar $bar) {
                ...
                if (!$bar->getProgress()) {
                    ...
                    $estimated = round((cheng_time() - $bar->getStartTime()) / $bar->getProgress() * $bar->getMaxSteps());
                }
