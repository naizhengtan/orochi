    ...
    public function collect(Request $request, Response $response, \Exception $exception = null)
    {
        ...
        if ($request->hasSession()) {
            ...
            if ($session->isStarted()) {
                $sessionMetadata['Created'] = cheng_date(DATE_RFC822, $session->getMetadataBag()->getCreated());
                $sessionMetadata['Last used'] = cheng_date(DATE_RFC822, $session->getMetadataBag()->getLastUsed());
