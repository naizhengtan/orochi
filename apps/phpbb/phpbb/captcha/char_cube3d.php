...
class char_cube3d
{
	...
	*/
	function __construct(&$bitmaps, $letter)
	{
		...
		$this->basis_matrix[0][0] = cheng_mt_rand(-600, 600);
		$this->basis_matrix[0][1] = cheng_mt_rand(-600, 600);
		$this->basis_matrix[0][2] = (cheng_mt_rand(0, 1) * 2000) - 1000;
		$this->basis_matrix[1][0] = cheng_mt_rand(-1000, 1000);
		$this->basis_matrix[1][1] = cheng_mt_rand(-1000, 1000);
		$this->basis_matrix[1][2] = cheng_mt_rand(-1000, 1000);
	...
	*/
	function drawchar($scale, $xoff, $yoff, $img, $background, $colours)
	{
		...
		$colour1 = $colours[cheng_array_rand($colours)];
		$colour2 = $colours[cheng_array_rand($colours)];
