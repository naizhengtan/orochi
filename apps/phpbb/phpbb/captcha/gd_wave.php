...
class gd_wave
{
	...
	function execute($code, $seed)
	{
		...
		$x_grid = cheng_mt_rand(6, 10);
		$y_grid = cheng_mt_rand(6, 10);
		...
		$box = array(
			'upper_left'	=> array(
				'x' => cheng_mt_rand(5, 15),
				'y' => cheng_mt_rand(10, 15)
			),
			'upper_right'	=> array(
				'x' => cheng_mt_rand($img_x - 35, $img_x - 19),
				'y' => cheng_mt_rand(10, 17)
			),
			'lower_left'	=> array(
				'x' => cheng_mt_rand($img_x - 45, $img_x - 5),
				'y' => cheng_mt_rand($img_y - 15, $img_y - 0),
			),
		);
		...
		// TODO
		$background = imagecolorallocate($img, cheng_mt_rand(155, 255), cheng_mt_rand(155, 255), cheng_mt_rand(155, 255));
		...
		for ($i = 0; $i < 15; ++$i)
		{
			$random[$i] = imagecolorallocate($img, cheng_mt_rand(120, 255), cheng_mt_rand(120, 255), cheng_mt_rand(120, 255));
		}

		$fontcolors[0] = imagecolorallocate($img, cheng_mt_rand(0, 120), cheng_mt_rand(0, 120), cheng_mt_rand(0, 120));

		$colors = array();

		$minr = cheng_mt_rand(20, 30);
		$ming = cheng_mt_rand(20, 30);
		$minb = cheng_mt_rand(20, 30);

		$maxr = cheng_mt_rand(150, 230);
		$maxg = cheng_mt_rand(150, 230);
		$maxb = cheng_mt_rand(150, 230);
		...
		$plane_offset_x = cheng_mt_rand(3, 8);
		$plane_offset_y = cheng_mt_rand( 12, 15);
