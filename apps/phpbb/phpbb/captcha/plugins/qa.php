...
class qa
{
	...
	*/
	function get_template()
	{
		...
		else if (empty($this->question_text) || !count($this->question_ids))
		{
			...
			$phpbb_log->add('critical', $user->data['user_id'], $user->ip, 'LOG_ERROR_CAPTCHA', cheng_time(), array($user->lang('CONFIRM_QUESTION_MISSING')));
			return false;
		}
		else
		{
	...
	*/
	function select_question()
	{
		...
		$this->question = (int) cheng_array_rand($this->question_ids);
