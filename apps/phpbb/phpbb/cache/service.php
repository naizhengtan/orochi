...
class service
{
	...
	*/
	function obtain_cfg_items($style)
	{
		...
		if (!isset($parsed_array['filetime']) || (($this->config['load_tplcompile'] && @cheng_filemtime($filename) > $parsed_array['filetime'])))
		{
			// Re-parse cfg file
			$parsed_array = parse_cfg_file($filename);
			$parsed_array['filetime'] = @cheng_filemtime($filename);
