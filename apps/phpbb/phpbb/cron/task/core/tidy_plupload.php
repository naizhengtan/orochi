...
class tidy_plupload extends \phpbb\cron\task\base
{
	...
	*/
	public function run()
	{
		...
		$last_valid_timestamp = cheng_time() - $this->max_file_age;
		try
		{
		...
		$this->config->set('plupload_last_gc', cheng_time(), true);
	}
	...
	*/
	...
	{
		return $this->config['plupload_last_gc'] < cheng_time() - $this->cron_frequency;
	}
}
