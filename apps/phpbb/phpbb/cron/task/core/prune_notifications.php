...
class prune_notifications extends \phpbb\cron\task\base
{
	...
	*/
	public function run()
	{
		...
		$timestamp = cheng_time() - ($this->config['read_notification_expire_days'] * 60 * 60 * 24);
	...
	*/
	...
	{
		return $this->config['read_notification_last_gc'] < cheng_time() - $this->config['read_notification_gc'];
	}
}
