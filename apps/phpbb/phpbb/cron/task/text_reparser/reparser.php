...
class reparser extends \phpbb\cron\task\base
{
	...
	public function should_run()
	{
		...
		{
			return $this->config[$this->reparser_name . '_last_cron'] < cheng_time() - $this->config[$this->reparser_name . '_cron_interval'];
		}
	...
	public function run()
	{
		if ($this->reparse_lock->acquire())
		{
			...
			$this->config->set($this->reparser_name . '_last_cron', cheng_time());
