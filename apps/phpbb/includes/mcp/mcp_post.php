...
function mcp_post_details($id, $mode, $action)
{
	...
	*/
	...
	{
    // cheng-hack: r=phpbb_reports, re=phpbb_reports_reasons
		//$sql = 'SELECT r.*, re.*, u.user_id, u.username
    $sql = 'SELECT
      r.report_id, r.reason_id, r.post_id, r.user_id, r.user_notify, r.report_closed, r.report_time,
      r.report_text, r.pm_id, r.reported_post_enable_bbcode , r.reported_post_enable_smilies,
      r.reported_post_enable_magic_url, r.reported_post_text , r.reported_post_uid , r.reported_post_bitfield,
      re.reason_id, re.reason_title, re.reason_description, re.reason_order,
...
function change_poster(&$post_info, $userdata)
{
	...
	markread('post', $post_info['forum_id'], $post_info['topic_id'], cheng_time(), $userdata['user_id']);
