...
function mcp_forum_view($id, $mode, $action, $forum_info)
{
	...
	*/
	...
	$limit_time_sql = ($sort_days) ? 'AND t.topic_last_post_time >= ' . (cheng_time() - ($sort_days * 86400)) : '';
  ...
  // cheng-hack: phpbb_topics
	//$sql = "SELECT t.*$read_tracking_select
  $sql = "SELECT t.topic_id, t.forum_id, t.icon_id, t.topic_attachment, t.topic_reported, t.topic_title, t.topic_poster,
  t.topic_time, t.topic_time_limit, t.topic_views, t.topic_status, t.topic_type, t.topic_first_post_id,
  t.topic_first_poster_name, t.topic_first_poster_colour, t.topic_last_post_id , t.topic_last_poster_id,
  t.topic_last_poster_name, t.topic_last_poster_colour, t.topic_last_post_subject, t.topic_last_post_time,
  t.topic_last_view_time, t.topic_moved_id , t.topic_bumped, t.topic_bumper, t.poll_title, t.poll_start,
  t.poll_length, t.poll_max_options, t.poll_last_vote , t.poll_vote_change , t.topic_visibility , t.topic_delete_time ,
  t.topic_delete_reason, t.topic_delete_user, t.topic_posts_approved , t.topic_posts_unapproved , t.topic_posts_softdeleted,
