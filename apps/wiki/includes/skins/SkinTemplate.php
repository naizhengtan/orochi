...
class SkinTemplate extends Skin {
    ...
    foreach ( $tpl->data['footericons'] as $footerIconsKey => /*&*/$footerIconsBlock ) {
        ...
        foreach ( $footerIconsBlock as $key=>/*&*/$footerIcon ) {
					if ( isset( $footerIcon['src'] ) ) {
						if ( !isset( $footerIcon['width'] ) ) {
							//$footerIcon['width'] = 88;
							$tpl->data['footericons'][$footerIconsKey][$key]['width'] = 88;
						}
						if ( !isset( $footerIcon['height'] ) ) {
							//$footerIcon['height'] = 31;
							$tpl->data['footericons'][$footerIconsKey][$key]['height'] = 31;
						}
					}
				}
			} else {
    ...
    foreach ( $content_navigation as $section => /*&*/$links ) {
      foreach ( $links as $key => /*&*/$link ) {
				$xmlID = $key;
				if ( isset( $content_navigation[$section][$key]['context'] ) && $content_navigation[$section][$key]['context'] == 'subject' ) {
					$xmlID = 'ca-nstab-' . $xmlID;
				} elseif ( isset( $content_navigation[$section][$key]['context'] ) && $content_navigation[$section][$key]['context'] == 'talk' ) {
					$xmlID = 'ca-talk';
					$content_navigation[$section][$key]['rel'] = 'discussion';
				} elseif ( $section == 'variants' ) {
					$xmlID = 'ca-varlang-' . $xmlID;
				} else {
					$xmlID = 'ca-' . $xmlID;
				}
				$content_navigation[$section][$key]['id'] = $xmlID;
			}
		}
