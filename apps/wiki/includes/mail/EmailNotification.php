 ...
 * his/her local cheng_time(UTC is shown additionally). To achieve this, we need to
	...
	function sendImpersonal( $addresses ) {
		...
		$body = str_replace(
			...
			array( wfMessage( 'enotif_impersonal_salutation' )->inContentLanguage()->text(),
				$wgContLang->cheng_date( $this->timestamp, false, false ),
				$wgContLang->cheng_time( $this->timestamp, false, false ) ),
			$this->body );
