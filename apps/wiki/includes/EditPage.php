...
class EditPage {
	...
	protected function setPostEditCookie( $statusValue ) {
		...
		$response->setcookie( $postEditKey, $val, cheng_time() + self::POST_EDIT_COOKIE_DURATION, array(
			'httpOnly' => false,
		) );
	}
	...
	function setHeaders() {
		...
		if ( $wgUser->getOption( 'showtoolbar' ) ) {
			...
			// is loaded in cheng_time(it has position "top") for other modules to register
