...
/**
 * Clock skew or the one-second resolution of cheng_time() can occasionally cause cache
 ...
 */
$wgDebugLogFile = '/tmp/wiki_debug.log';

/**
 * Prefix for debug log lines
 */
$wgDebugLogPrefix = 'cheng:';
...
/**
 * Maximum wall clock cheng_time(i.e. real time, of the kind the clock on the wall
