...
class PaperInfo {
    ...
    public function fetch_comments($where) {
        ...
        $result = Dbl::qe("select PaperComment.commentId, PaperComment.contactId, PaperComment.paperId, PaperComment.timeModified, PaperComment.timeNotified, PaperComment.comment, PaperComment.commentType, PaperComment.replyTo, PaperComment.paperStorageId, PaperComment.ordinal, PaperComment.commentTags, PaperComment.commentRound,
    ...
    public function notify($notifytype, $callback, $contact) {
        ...
        $q .= " order by conflictType, ContactInfo.contactId";
