...
class UserActions {
    ...
    static private function modify_password_mail($where, $dopassword, $sendtype, $ids) {
        ...
        $result = Dbl::qe("select contactId, firstName, lastName, unaccentedName, email, preferredEmail, affiliation, voicePhoneNumber, faxPhoneNumber, password, passwordTime, passwordIsCdb, collaborators, creationTime, lastLogin, defaultWatch, roles, disabled, contactTags, data from ContactInfo where $where and contactId ?a", $ids);
