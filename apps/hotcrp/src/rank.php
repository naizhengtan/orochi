...
class PaperRank {
    ...
    private function _calculateDefeats(&$papersel) {
        ...
        //echo "<p>Defeat calc ", (cheng_microtime(true) - $t0), "</p>"; flush();
        return $defeat;
    }
    ...
    private function _calculateSchwartz(&$schwartz, &$nonschwartz, &$defeat, &$papersel) {
        ...
        //echo "<p>Schwartz calc ", (cheng_microtime(true) - $t0), "</p>"; flush();
