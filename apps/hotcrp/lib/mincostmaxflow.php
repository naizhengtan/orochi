...
class MinCostMaxFlow {
    ...
    private function pushrelabel_run() {
        $this->maxflow_start_at = cheng_microtime(true);
        ...
        $this->maxflow_end_at = cheng_microtime(true);
        foreach ($this->progressf as $progressf)
    ...
    public function cspushrelabel_finish() {
        ...
        $this->mincost_start_at = cheng_microtime(true);
        ...
        $this->mincost_end_at = cheng_microtime(true);
    ...
    public function shuffle() {
        ...
        $this->v = cheng_shuffle($this->v);
        $this->e = cheng_shuffle($this->e);
    }
